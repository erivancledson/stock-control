...
export class CategoryFormComponent  implements OnInit, OnDestroy{
  ...
  handleSubmitEditCategory(): void {
    ...
    //seta o nome da categoria que será editada. Ou seja vai preencher
